...
class UserDAOImplSpec extends PlaySpecification with MongoSpecification {
  ...
  "The `find` method" should {
    "find a user for the given sign_in info" in new WithMongo with Context {
    ...
    "return None if no user for the given sign_in info exists" in new WithMongo with Context {
  ...
  trait Context extends MongoScope {
    ...
    /**
     * A sign_in info for the stored user.
     */
