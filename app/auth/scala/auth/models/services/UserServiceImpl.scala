...
class UserServiceImpl @Inject() (userDAO: UserDAO, clock: Clock)(
  ...
  /**
   * Retrieves a user that matches the specified sign_in info.
   *
   * @param loginInfo The sign_in info to retrieve a user.
   * @return The retrieved user or None if no user could be retrieved for the given sign_in info.
   */
